...
public class Album {
    ...
    public Album(long id, long userId, String name, List<Long> sharedUsers, Boolean isChronologicalOrder) {
        this.id = id;
        this.userId = userId;
        this.name = name;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, userId, name, sharedUsers, isChronologicalOrder);
    }
}
